...
import { AppBar, Box, Button, Container, createTheme, CssBaseline, Link, Paper, Snackbar, ThemeProvider, Toolbar, Tooltip, Typography } from '@mui/material';
...
function Popup() {
  ...
  const handleOpenRelayTab = useCallback(() => {
    chrome.tabs.create({ url: 'relay.html' });
  }, []);
      ...
      <Container fixed>
        <Paper elevation={6}>
          <Box p={2} mt={2} mb={2} minWidth={240} minHeight={280} width={240}>
            ...
            <Box mt={1}>
              <Tooltip title="Add / Delete Relays">
                <Button onClick={handleOpenRelayTab} variant="outlined" color="primary">Edit Relays</Button>
              </Tooltip>
            </Box>
            <Box mt={3}>
